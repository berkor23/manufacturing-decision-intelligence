...
export const FEATURE_META: Record<DiagnosticFeatureKey, FeatureMeta> = {
  ...
  mandatoryCriteriaDefined: {
    key: "mandatoryCriteriaDefined",
    label: "Zorunlu kriterler belli mi",
    questionTheme: "Bir alternatifin mutlaka karşılaması gereken, karşılamazsa eleneceği zorunlu kriterler belli mi?",
    traceWhenTrue: "Eleme yapan zorunlu kriterler tanımlı",
    traceWhenFalse: "Zorunlu kriterler henüz tanımlı değil",
  },
  preferenceCriteriaDefined: {
    key: "preferenceCriteriaDefined",
    label: "Tercih kriterleri belli mi",
    questionTheme: "Alternatifleri karşılaştırmak için ağırlıklandırılabilecek tercih kriterleri belli mi?",
    traceWhenTrue: "Ağırlıklandırılabilir tercih kriterleri tanımlı",
    traceWhenFalse: "Tercih kriterleri henüz tanımlı değil",
  },
  decisionOwnerKnown: {
    key: "decisionOwnerKnown",
    label: "Karar sahibi belli mi",
    questionTheme: "Son kararı kimin vereceği ve kararın hangi tarihe kadar verilmesi gerektiği belli mi?",
    traceWhenTrue: "Karar sahibi ve karar zamanı belli",
    traceWhenFalse: "Karar sahipliği veya zamanı henüz net değil",
  },
  constraintQueue: {
    key: "constraintQueue",
    label: "Kısıt önünde kuyruk var mı",
    questionTheme: "Kısıt olduğunu düşündüğünüz noktanın önünde düzenli olarak kuyruk veya ara stok birikiyor mu?",
    traceWhenTrue: "Kısıt önünde düzenli kuyruk/ara stok oluşuyor",
    traceWhenFalse: "Kısıt önünde düzenli birikme görülmüyor",
  },
  downstreamStarvation: {
    key: "downstreamStarvation",
    label: "Sonraki adımlar aç kalıyor mu",
    questionTheme: "Bu noktanın sonrasındaki istasyonlar malzeme beklediği için zaman zaman boş kalıyor mu?",
    traceWhenTrue: "Kısıt sonrasında açlık veya boş kapasite görülüyor",
    traceWhenFalse: "Kısıt sonrasında açlık görülmüyor",
  },
  constraintMeasured: {
    key: "constraintMeasured",
    label: "Kısıt sayısal olarak doğrulandı mı",
    questionTheme: "Bu noktanın kapasitesi ile talebi aynı birimde karşılaştırıp kısıt olduğunu sayısal olarak doğruladınız mı?",
    traceWhenTrue: "Kısıt kapasite-talep karşılaştırmasıyla doğrulandı",
    traceWhenFalse: "Kısıt henüz sayısal olarak doğrulanmadı",
  },
  multipleAlternativesDefined: {
    key: "multipleAlternativesDefined",
    label: "En az iki gerçek alternatif var mı",
    questionTheme: "Karşılaştırabileceğiniz, uygulanabilir en az iki somut alternatif gerçekten tanımlı mı?",
    traceWhenTrue: "Karşılaştırılabilir en az iki gerçek alternatif tanımlı",
    traceWhenFalse: "Karar analizi için yeterli alternatif henüz tanımlı değil",
  },
  unresolvedCauseBeforeDecision: {
    key: "unresolvedCauseBeforeDecision",
    label: "Önce çözülmesi gereken bilinmeyen neden var mı",
    questionTheme: "Seçim yapmadan önce, seçeneklerden bağımsız olarak kök nedeni bilinmeyen bir arıza veya sapmayı çözmeniz gerekiyor mu?",
    traceWhenTrue: "Seçimden önce çözülmesi gereken bilinmeyen nedenli problem var",
    traceWhenFalse: "Kararı engelleyen ayrı bir bilinmeyen nedenli problem yok",
  },
  constraintLeverageExpected: {
    key: "constraintLeverageExpected",
    label: "Kısıt iyileşirse toplam çıktı artar mı",
    questionTheme: "Bu noktanın kapasitesi artırıldığında yalnız yerel değil, sistemin toplam iyi ürün çıktısının da artacağını gösterebiliyor musunuz?",
    traceWhenTrue: "Kısıt iyileştirmesinin toplam sistem çıktısını artırması bekleniyor",
    traceWhenFalse: "Yerel iyileştirmenin toplam sistem çıktısına etkisi doğrulanmadı",
  },
  potentialEffectKnown: {
    key: "potentialEffectKnown",
    label: "Potansiyel etkinin sonucu belli mi",
  ...
  controlAdequacyUncertain: {
    ...
    label: "Mevcut kontrollerin yeterliliği belirsiz mi",
    questionTheme: "Mevcut önleme ve yakalama kontrollerinin yeni koşulda gerçekten çalışacağı konusunda doğrulanmamış bir varsayım var mı?",
    traceWhenTrue: "Mevcut önleme/yakalama kontrollerinin yeterliliği belirsiz",
    traceWhenFalse: "Mevcut kontrollerin yeterliliği yeni koşul için doğrulandı",
  },
};
